    ...
    if (step === 1) {
      stepMarkup = (
        <div className="creator__container">
          <div className="meter">
            <div className="meter__progress" style={{ width: "0%" }} />
          </div>
          <h3 className="step__header">Step 1/3: Create an account</h3>
      ...
      stepMarkup = (
        <div className="creator__container">
          <div className="meter">
            <div className="meter__progress" style={{ width: "33.3%" }} />
          </div>
      ...
      stepMarkup = (
        <div className="creator__container">
          <div className="meter">
            <div className="meter__progress" style={{ width: "66.6%" }} />
          </div>
          <h3 className="step__header">Step 3/3: Go private</h3>
          <p className="step__info">
            Make your account private so only subscribers have access by{" "}
            <a
      ...
      stepMarkup = (
        <div>
          <div className="meter">
            <div className="meter__progress" style={{ width: "100%" }} />
          </div>
